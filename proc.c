...
/*The following code is added by Bharat vxc210006.
**This function is used to set the process tickets.
*/
...
/* The following code is added by Bharat vxc210006.
** Function to store the process tickets
*/
...
/*The following code is added by Bharat vxc210006.
** This function is used to restore tickets.
*/
...
fork(void)
{
  ...
  *np->tf = *proc->tf;
  ...
  /* The following code is added by Bharat vxc210006.
  **During fork, parent and child will have same no of tickets.
  */
...
exit(void)
{
  ...
  /*The following code is added by Bharat vxc210006
  ** Remove the tickets from lottery.*/ 
...
wait(void)
{
  ...
  for(;;){
	...
	/*The following code is added by Bharat vxc210006
        ** When the process state is zombie, reset ticks.*/
	p->ticks = 0;
        setproctickets(p, 0);
	//End of code added
        release(&ptable.lock);
...
scheduler(void)
{
  ...
  /* The following code is added by Bharat vxc210006.
  **Initialize init process tickets to 1.
  */
  acquire(&ptable.lock);
  ...
  */
  ...
  for(;;){
    ...
    /* The following code is added by Bharat vxc210006.
    **use the random function to create the winner ticket.
    */
	...
	/* The following code is added by Bharat vxc210006.
	**method to find out the lottery ticket.
	*/
        ticket_count += p->tickets;
...
sleep(void *chan, struct spinlock *lk)
{
  ...
  /*The following code is added by Bharat vxc210006.
  **Have record of tickets before sleep state.
  */
  storetickets(proc);
  // End of code added 
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
	...
	/* The following code is added by Bharat vxc210006.
	**Restore the tickets before waking up.
	*/
        restoretickets(p);
	// End of code added 
...
kill(int pid)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
      ...
      if(p->state == SLEEPING)
	{
	  ...
	  /* The following code is added by Bharat vxc210006.
	  **restore tickets before waking up.
	  */
          restoretickets(p);
	  // End of code added 
